  ...
  if(finduser)
  {
    ...
    .then(resp => {
      ...
      if(resp){
          ...
          const token=jwt.sign({userId:finduser._id,email:finduser.email,firstName:finduser.firstName,lastName:finduser.lastName},process.env.JWT_KEY,{expiresIn:'2d'})
